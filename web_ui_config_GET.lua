...
return function(state,s,data)
    ...
    return http_util.reply_json(s,{name=config.get_value("name"),version=config.get_value("version"),wifi_mode=mode_map[wifi.getmode()],wifi_ap={ap_ssid,ap_password},wifi_sta={sta_ssid,sta_password}})
end
